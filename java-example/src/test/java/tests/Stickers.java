...
public class Stickers extends TestBase {
  ...
  public void stickersTest() {
    app.driver.navigate().to("http://localhost/litecart/");//открыть  litecart на главной странице
    List<WebElement> products = app.driver.findElements(By.className("image-wrapper"));//получить список всех товаров с главной страницы
