...
public class AddNewProduct extends TestBase {
  ...
  public void addNewProductTest() throws InterruptedException {
    JavascriptExecutor jsExecutor = (JavascriptExecutor) app.driver;
    ...
    app.driver.findElement(By.xpath("//label[text()=' Enabled']")).click();
    app.driver.findElement(By.name("name[en]")).sendKeys(name);
    //driver.findElement(By.name("name[en]")).sendKeys(name);
    app.driver.findElement(By.name("code")).sendKeys(name);

    //Categories - хочу установить чек бокс только на Rubber Ducks и убедиться, что остальные чек-боксы не выбраны
    WebElement categories = app.driver.findElement(By.xpath("//input[@name='categories[]'][@data-name='Root']"));
    if (!categories.isSelected()) {
      categories.click();
    }
    WebElement rubberDucks = app.driver.findElement(By.xpath("//input[@name='categories[]'][@data-name='Rubber Ducks']"));
    if (!categories.isSelected()) {
      rubberDucks.click();
    }
    WebElement subcategory = app.driver.findElement(By.xpath("//input[@name='categories[]'][@data-name='Subcategory']"));
    ...
    WebElement female = app.driver.findElement(By.xpath("//input[@value='1-2']"));
    if (female.isSelected()) {
      female.click();
    }
    WebElement male = app.driver.findElement(By.xpath("//input[@value='1-1']"));
    if (male.isSelected()) {
      male.click();
    }
    WebElement unisex = app.driver.findElement(By.xpath("//input[@value='1-3']"));
    ...
    //Добавить количество
    WebElement quantity = app.driver.findElement(By.name("quantity"));
    quantity.clear();
    quantity.sendKeys("5");

    //Определить наличие
    WebElement dropdownSoldOutStatus = app.driver.findElement(By.name("sold_out_status_id")); // Найти выпадающийо список
    ...
    WebElement foto = app.driver.findElement(By.xpath("//input[@name='new_images[]']"));
    ...
    //Selects
    WebElement manufacturer = app.driver.findElement(By.name("manufacturer_id")); // Найти выпадающийо список
    ...
    WebElement supplier = app.driver.findElement(By.name("supplier_id")); // Найти выпадающийо список
    ...
    WebElement shortDescript = app.driver.findElement(By.name("short_description[en]"));
    ...
    WebElement editor = app.driver.findElement(By.className("trumbowyg-editor"));
    ...
    WebElement purchasePrice = app.driver.findElement(By.name("purchase_price_currency_code"));
    Select select3 = new Select(purchasePrice);
    String currencyValue = "USD";
    select3.selectByValue(currencyValue);

    WebElement taxClass = app.driver.findElement(By.name("tax_class_id"));
...
/**Сохранить**/
    ...
    app.driver.findElement(By.linkText("Rubber Ducks")).click();//на всякий случай захожу в нужную категорию, куда сохраняла товар
    assertTrue(app.isElementPresent(By.linkText(name)));
